...
var (
	...
	redisAddr  = flag.String("redis-server", os.Getenv("REDIS_ADDR"), "Redis server to publish messages to")
	redisQueue = flag.String("redis-queue", os.Getenv("REDIS_QUEUE"), "Redis queue to publish messages to")
)
